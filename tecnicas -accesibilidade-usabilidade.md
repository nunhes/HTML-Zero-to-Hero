...
- **Definición de accesibilidade**: É a práctica de garantir que o contido web estea dispoñible para todos, independentemente das súas limitacións físicas, cognitivas ou técnicas.
- **Aplicación da accesibilidade**: Inclúe o uso de etiquetas semánticas en HTML (`<header>`, `<nav>`, `<main>`), atributos `alt` en imaxes, contraste de cores adecuado e navegación con atallos de teclado.
